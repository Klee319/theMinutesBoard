  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-full mx-auto p-2 md:p-4">
        {/* モバイル用タブ */}
        {isMobile && displayMeeting && !isLiveMode && currentTab === 'history' && (
        ...
        <div className="flex gap-4 h-[calc(100vh-120px)] md:h-[calc(100vh-140px)]">
          ...
          <div className={`flex-1 min-w-0 ${isMobile && activePanel !== 'main' ? 'hidden' : ''}`}>
                ...
                <div className="flex-1 flex gap-4">
                  {currentTab === 'history' ? (
                    <>
                      ...
                      {/* ネクストステップパネル（会議ごと） */}
                      {showNextStepsPanel && selectedMeeting && !isMobile && (
                      ...
                      {/* AIチャットパネル（会議ごと） */}
                      {showChatPanel && selectedMeeting && !isMobile && (
                        <div className="w-80 flex-shrink-0">
                          <div className="bg-white rounded-lg shadow-sm h-full">
                            <div className="flex items-center justify-between p-4 border-b">
            ...
            {isLiveMode && (
              <div className="flex gap-4 h-full">
                ...
                {/* ネクストステップパネル（ライブモード） */}
                {showNextStepsPanel && currentMeeting && !isMobile && (
                  <div className="w-80 flex-shrink-0">
                    <div className="bg-white rounded-lg shadow-sm h-full">
                      <div className="flex items-center justify-between p-4 border-b">
                        <h3 className="text-lg font-semibold text-gray-900">ネクストステップ</h3>
                      ...
                      <div className="h-[calc(100%-60px)]">
                        <MeetingNextSteps meeting={currentMeeting} />
                      </div>
                    </div>
                  </div>
                )}
                ...
                {/* AIチャットパネル（ライブモード） */}
                {showChatPanel && currentMeeting && !isMobile && (
                  <div className="w-80 flex-shrink-0">
                    <div className="bg-white rounded-lg shadow-sm h-full">
                      <div className="flex items-center justify-between p-4 border-b">
                        <h2 className="text-lg font-semibold text-gray-900">AIチャット</h2>
                      ...
                      <div className="h-[calc(100%-60px)]">
                        <ChatPanel meeting={currentMeeting} isLiveMode={true} />
                      </div>
                    </div>
                  </div>
                )}
          ...
          {isMobile && displayMeeting && !isLiveMode && currentTab === 'history' && (
            <>
              {/* ネクストステップパネル（モバイル） */}
              {activePanel === 'nextsteps' && selectedMeeting && (
              ...
              {/* AIチャットパネル（モバイル） */}
              {activePanel === 'chat' && selectedMeeting && (
                <div className="w-full">
                  <div className="bg-white rounded-lg shadow-sm h-full">
                    <ChatPanel meeting={selectedMeeting} isLiveMode={false} />
                  </div>
